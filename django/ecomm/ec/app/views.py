...
from . models import Product, Cart, OrderPlaced, Payment, Customer
...
#If you want to display some data you used method GET.If you want to perform some action of Form used POST
